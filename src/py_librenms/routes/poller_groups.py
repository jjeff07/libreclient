...
class PollerGroups:
    ...
    async def get_poller_group(self, poller_group: str | int | None = None) -> PollerGroupsResponse:
...
PollerGroupsSync = synchronizer.wrap(PollerGroups, name="PollerGroupsSync", target_module=__name__)
